...
// Si no encuentra la sección → fallback
if (start === -1 || end === -1) {
...
<head>
  ...
  <style>
    ...
    .details { background: white; border-radius: 8px; border: 1px solid #ddd; padding: 20px; white-space: pre-wrap; font-size: 13px; overflow-x: auto; }
  </style>
</head>
<body>
